...
if (isset($_POST['select-room'], $_POST['room-price'])) {
    $roomId = trim(filter_var($_POST['select-room'], FILTER_SANITIZE_NUMBER_INT));
    $newPrice = trim(filter_var($_POST['room-price'], FILTER_SANITIZE_NUMBER_INT));
...
if (isset($_POST['select-feature'], $_POST['feature-price'])) {
    ...
    $newPrice = trim(filter_var($_POST['feature-price'], FILTER_SANITIZE_NUMBER_INT));
